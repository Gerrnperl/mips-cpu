...
class RTypeInstParser {
    constructor(funct) {
        this.opcode = 0b000000;
        this.funct = funct;
    }
    parse({ op, args, srcLine }, symbolTable) {
        // op rd, rs, rt
        // =>
...
class BTypeInstParser {
    constructor(opcode) {
        this.opcode = opcode;
    }
    parse({ op, args, srcLine, codeLine }, symbolTable) {
        // b** rs, rt, imm
        // =>
